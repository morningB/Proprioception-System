...
public class RightHand : MonoBehaviour
{
 ...
 //   public Image handImage;
    ...
    private string resultFile = "Assets/Resources/RH/re.csv";
    ...
    private Vector3 GetRightShoulderPosition()
    {
        KinectWrapper.NuiSkeletonPositionIndex joint = KinectWrapper.NuiSkeletonPositionIndex.ShoulderRight;
        KinectManager manager = KinectManager.Instance;
        Vector3 jointPos = Vector3.zero;
