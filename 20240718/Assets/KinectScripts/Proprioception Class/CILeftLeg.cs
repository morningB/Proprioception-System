...
public class CILeftLeg : BodyController
{
    protected override string CsvDirectory => "Assets/Resources/Left Leg";
    ...
    protected override float CalculateAngle()
    {
        ...
        Vector3 HipRight = GetJointPosition(KinectWrapper.NuiSkeletonPositionIndex.HipRight);
        Vector3 AnkleRight = GetJointPosition(KinectWrapper.NuiSkeletonPositionIndex.AnkleRight);
        return Vector3.Angle(AnkleLeft - HipRight, HipRight - AnkleRight);
    }
